  ...
  return (
    <div className="img-container">
      <div
        ...
        className={cn(
          "img rounded-[48px] w-wclamp344 h-hclamp344 xl:w-[325px] xl:h-[350px] z-10 md:block self-start bg-elevation_one bg-cover bg-center bg-no-repeat bg-[url('/azuki.png')] hidden"
        )}
        style={{
          transform: `
