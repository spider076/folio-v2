      ...
      <div className="relative h-full">
        ...
        <div className="  flex flex-col items-start  dark:border-gray-800 rounded p-4 relative">
          ...
          <div className="my-4">
            {icon === "renthub" && (
              <img
                src="https://www.renthub.cloud/flux_home.svg"
                alt="renthub-logo"
                className="h-20 w-20"
              />
              // <svg
            ...
            {icon === "edobomedical" && (
              <img
                src="https://edobomedical.vercel.app/edoboLogo.svg"
                alt="edobomedical-logo"
                className="h-20 w-20"
              />
            )}
            {icon === "squadai" && (
              <img
                src="https://imgs.search.brave.com/sKgvPwQNGqz8vomhUER9yN9KQauJebG8DfY-YPIyeo8/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9tZWRp/YS5pc3RvY2twaG90/by5jb20vaWQvMTEz/ODYzNzgxNS92ZWN0/b3IvZ2VvbWV0cmlj/LXZlY3Rvci1sb2dv/LWxldHRlci1zLmpw/Zz9zPTYxMng2MTIm/dz0wJms9MjAmYz1z/VDZvYXc0Z1VDb0RM/OUxFRnJlQVRhSnJs/Y2d2SVZ3d2g1MmU2/YV9rTlc0PQ"
                alt="Squadai"
                className="h-20 w-20"
              />
            )}
            {icon === "opinex" && (
              <img
                src="https://imgs.search.brave.com/uNCN9Cy-RjNCaeHO14rQsmBJO5bv7YyxvOPl0hDXX6E/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pLnBp/bmltZy5jb20vb3Jp/Z2luYWxzLzBmL2E3/L2M2LzBmYTdjNjM3/NTkwY2JlYzcyMmJl/NjdhNGRhNWQ5MGI3/LmpwZw"
                alt="Opinex"
                className="h-20 w-20"
              />
            )}
            {icon === "codehive" && (
              <img
                src="https://thecodehive.online/assets/logo1.png"
                alt="Codehive"
                className="h-15 w-40"
              />
            )}
